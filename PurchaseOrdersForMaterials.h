...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Size = System::Drawing::Size(1460, 366);
			...
			this->button1->Text = L"Создать заказ на покупку материалов";
			this->button1->UseVisualStyleBackColor = true;
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(2, 441);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(334, 23);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Удолить заказ на закупку материалов";
