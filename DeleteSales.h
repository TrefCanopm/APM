...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(446, 27);
			this->label1->TabIndex = 0;
			this->label1->Text = L"¬ведите номер заказа который надо удалить";
			// 
			// button1
			// 
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(464, 32);
			...
			this->Text = L"”даление записи о заказе на продажу";
