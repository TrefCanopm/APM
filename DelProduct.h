...
namespace APM {
	...
	/// —водка дл€ DelProduct
	/// </summary>
	public ref class DelProduct : public System::Windows::Forms::Form
	{
	public:
		DelProduct(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Size = System::Drawing::Size(269, 32);
			this->button1->TabIndex = 2;
			this->button1->Text = L"ќтмена";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &DelProduct::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(287, 76);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(327, 32);
			this->button2->TabIndex = 3;
			this->button2->Text = L"”далить";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &DelProduct::button2_Click);
			// 
			// DelProduct
			// 
